        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 14*fem, 37*fem, 10*fem),
                    width: 54*fem,
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(258*fem, 0*fem, 0*fem, 7.5*fem),
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(56*fem, 0*fem, 43*fem, 20*fem),
              padding: EdgeInsets.fromLTRB(78*fem, 0*fem, 80*fem, 0*fem),
              width: double.infinity,
              child: Center(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(15*fem, 0*fem, 19*fem, 34*fem),
              width: double.infinity,
              height: 176*fem,
              child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 7*fem, 16*fem, 0*fem),
                                width: 30*fem,
                                height: 30*fem,
                                decoration: BoxDecoration (
                              ...
                              Container(
                                ...
                                padding: EdgeInsets.fromLTRB(0*fem, 6.5*fem, 0*fem, 6.5*fem),
                                width: 342*fem,
                                height: double.infinity,
                                decoration: BoxDecoration (
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 103.84*fem, 0*fem),
                                        child: Text(
                                          'Emergency Contact',
                                          style: SafeGoogleFont (
                                            'SF Pro Text',
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 192.84*fem, 0*fem),
                                        child: Text(
                                          'Family',
                                          style: SafeGoogleFont (
                                            'SF Pro Text',
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 185.84*fem, 0*fem),
                                        child: Text(
                                          'Label-4',
                                          style: SafeGoogleFont (
                                            'SF Pro Text',
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(15*fem, 0*fem, 19*fem, 209*fem),
              width: double.infinity,
              height: 44*fem,
              child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 214.84*fem, 0*fem),
                                  child: Text(
                                    'Sign Out',
                                    style: SafeGoogleFont (
                                      'SF Pro Text',
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(38*fem, 3.5*fem, 51*fem, 0*fem),
              width: double.infinity,
              height: 50*fem,
              decoration: BoxDecoration (
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(11.69*fem, 0*fem, 0*fem, 70*fem),
                    height: 44.5*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 99.2*fem, 0*fem),
                          width: 28.61*fem,
                          height: double.infinity,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                ...
                                padding: EdgeInsets.fromLTRB(0*fem, 3.63*fem, 0*fem, 2.33*fem),
                                width: double.infinity,
                                child: Center(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(4.66*fem, 0*fem, 4.67*fem, 0.5*fem),
                                padding: EdgeInsets.fromLTRB(0*fem, 5.48*fem, 0*fem, 3.72*fem),
                                width: double.infinity,
                                child: Center(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0.89*fem, 0*fem, 0.89*fem, 0.5*fem),
                                padding: EdgeInsets.fromLTRB(0*fem, 3.93*fem, 0*fem, 2.86*fem),
                                width: double.infinity,
                                child: Center(
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(0*fem, 16.5*fem, 0*fem, 45.5*fem),
                    width: 250*fem,
                    decoration: BoxDecoration (
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(73*fem, 0*fem, 72*fem, 6.5*fem),
                              padding: EdgeInsets.fromLTRB(0*fem, 21.5*fem, 0*fem, 17.5*fem),
                              width: double.infinity,
                              child: Center(
